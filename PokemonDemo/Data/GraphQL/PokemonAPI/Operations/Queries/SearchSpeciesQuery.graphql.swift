...
extension PokemonAPI {
  nonisolated struct SearchSpeciesQuery: GraphQLQuery {
    static let operationName: String = "SearchSpecies"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query SearchSpecies($search: String!, $limit: Int!, $offset: Int!) { pokemon_v2_pokemonspecies( where: { name: { _ilike: $search } } limit: $limit offset: $offset ) { __typename id name capture_rate pokemon_v2_pokemoncolor { __typename name } pokemon_v2_pokemons { __typename id name pokemon_v2_pokemonabilities { __typename pokemon_v2_ability { __typename name } } } } }"#
      ))
    ...
    nonisolated struct Data: PokemonAPI.SelectionSet {
      ...
      nonisolated struct Pokemon_v2_pokemonspecy: PokemonAPI.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
          SearchSpeciesQuery.Data.Pokemon_v2_pokemonspecy.self
        ] }
        ...
        nonisolated struct Pokemon_v2_pokemoncolor: PokemonAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            SearchSpeciesQuery.Data.Pokemon_v2_pokemonspecy.Pokemon_v2_pokemoncolor.self
          ] }
        ...
        nonisolated struct Pokemon_v2_pokemon: PokemonAPI.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
            SearchSpeciesQuery.Data.Pokemon_v2_pokemonspecy.Pokemon_v2_pokemon.self
          ] }
          ...
          nonisolated struct Pokemon_v2_pokemonability: PokemonAPI.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
              SearchSpeciesQuery.Data.Pokemon_v2_pokemonspecy.Pokemon_v2_pokemon.Pokemon_v2_pokemonability.self
            ] }
            ...
            nonisolated struct Pokemon_v2_ability: PokemonAPI.SelectionSet {
              ...
              static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] { [
                SearchSpeciesQuery.Data.Pokemon_v2_pokemonspecy.Pokemon_v2_pokemon.Pokemon_v2_pokemonability.Pokemon_v2_ability.self
              ] }
